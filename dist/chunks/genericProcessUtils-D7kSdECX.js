import{n as e}from"./chunk-DR8-3Aex.js";import{i as t,n,r}from"./execFileNoThrow-B79xN8lv.js";function i(e){if(e<=1)return!1;try{return process.kill(e,0),!0}catch{return!1}}async function a(e,t=10){if(process.platform===`win32`){let r=await n(`powershell.exe`,[`-NoProfile`,`-Command`,`
      $pid = ${String(e)}
      $ancestors = @()
      for ($i = 0; $i -lt ${t}; $i++) {
