import{n as e}from"./chunk-DR8-3Aex.js";import{i as t,o as n,t as r}from"./cliLaunch-BG-BIg9j.js";import{a as i,i as a,n as o,r as s,t as c}from"./state-Cfbk8uiO.js";import{resolve as l}from"path";async function u(e){let t=e[0]||`status`;switch(t){case`start`:await h(e.slice(1));break;case`stop`:await p();break;case`status`:case`ps`:await f();break;case`bg`:await(await import(`./bg-BJwAYk_W.js`)).handleBgStart(e.slice(1));break;case`attach`:await(await import(`./bg-BJwAYk_W.js`)).attachHandler(e[1]);break;case`logs`:await(await import(`./bg-BJwAYk_W.js`)).logsHandler(e[1]);break;case`kill`:await(await import(`./bg-BJwAYk_W.js`)).killHandler(e[1]);break;case`--help`:case`-h`:case`help`:d();break;default:console.error(`Unknown daemon subcommand: ${t}`),d(),process.exitCode=1}}function d(){console.log(`
