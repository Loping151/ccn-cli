import{n as e,o as t}from"./chunk-DR8-3Aex.js";import{Rn as n,b as r,f as i,t as a,x as o,xt as s}from"./src-D27W8oyB.js";import{t as c}from"./jsx-runtime-D-D469L8.js";import{li as l,ui as u}from"./paths-CEBN0NNM.js";import{OS as d,_g as f,gg as p,jS as m}from"./loadAgentsDir-F091gZuA.js";function h(){let e=f();return l()===`zh`?`# Skill Search (自动技能匹配)
...
`)}async function _(){if(f()&&process.env.SKILL_SEARCH_ENABLED!==`0`)return`Skill Search: already enabled`;process.env.SKILL_SEARCH_ENABLED=`1`;let e=[`Skill Search: enabled (SKILL_SEARCH_ENABLED=1)`];try{let{clearSkillIndexCache:t}=await import(`./localSearch-iAsxmJjh.js`);t(),e.push(`Skill index cache: cleared (will rebuild on next search)`)}catch{e.push(`Skill index cache: clear skipped`)}return e.join(`
`)}async function v(){return f()?(process.env.SKILL_SEARCH_ENABLED=`0`,`Skill Search: disabled (SKILL_SEARCH_ENABLED=0)`):`Skill Search: already disabled`}function y({onDone:e}){m(`skill-search-panel`);let[t,n]=(0,x.useState)(0),a=(0,x.useMemo)(()=>[{label:`Status`,description:`Show whether automatic skill matching is active`,run:()=>Promise.resolve(g())},{label:`Start`,description:`Enable automatic skill matching for this session`,run:_},{label:`Stop`,description:`Disable automatic skill matching for this session`,run:v},{label:`About`,description:`How automatic skill matching works`,run:()=>Promise.resolve(h())}],[]),c=()=>{let n=a[t];n&&n.run().then(t=>{e(t,{display:`system`})})};return s((e,t)=>{if(t.upArrow){n(e=>Math.max(0,e-1));return}if(t.downArrow){n(e=>Math.min(a.length-1,e+1));return}t.return&&c()}),(0,S.jsx)(i,{title:`Skill Search`,subtitle:`${a.length} actions`,onCancel:()=>e(`Skill search panel dismissed`,{display:`system`}),color:`background`,hideInputGuide:!0,children:(0,S.jsxs)(o,{flexDirection:`column`,children:[a.map((e,n)=>(0,S.jsxs)(o,{flexDirection:`row`,children:[(0,S.jsx)(r,{children:`${n===t?`›`:` `} ${e.label}`.padEnd(C)}),(0,S.jsx)(r,{dimColor:!0,children:e.description})]},e.label)),(0,S.jsx)(o,{marginTop:1,children:(0,S.jsx)(r,{dimColor:!0,children:`↑/↓ select · Enter run · Esc close`})})]})})}async function b(e,t,n){let r=n?.trim()??``;return r===`start`?(e(await _(),{display:`system`}),null):r===`stop`?(e(await v(),{display:`system`}),null):r===`about`?(e(h(),{display:`system`}),null):r===`status`?(e(g(),{display:`system`}),null):(0,S.jsx)(y,{onDone:e})}var x,S,C;e((()=>{x=t(n(),1),a(),d(),p(),u(),S=c(),C=28}))();export{b as call};