import{n as e,o as t}from"./chunk-DR8-3Aex.js";import{ii as n,ri as r}from"./paths-CIl-ozdy.js";import{Rn as i,b as a,f as o,t as s,x as c,xt as l}from"./src-Kfqxxbsd.js";import{t as u}from"./jsx-runtime-BLYyAvvR.js";import{OS as d,hg as f,jS as p,mg as m}from"./loadAgentsDir-atKeDaX0.js";function h(){let e=f();return r()===`zh`?`# Skill Search (自动技能匹配)
...
`)}async function _(){if(f()&&process.env.SKILL_SEARCH_ENABLED!==`0`)return`Skill Search: already enabled`;process.env.SKILL_SEARCH_ENABLED=`1`;let e=[`Skill Search: enabled (SKILL_SEARCH_ENABLED=1)`];try{let{clearSkillIndexCache:t}=await import(`./localSearch-BTsauwZN.js`);t(),e.push(`Skill index cache: cleared (will rebuild on next search)`)}catch{e.push(`Skill index cache: clear skipped`)}return e.join(`
