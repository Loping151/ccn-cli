import{n as e,o as t}from"./chunk-DR8-3Aex.js";import{Rn as n,b as r,f as i,t as a,x as o,xt as s}from"./src-D27W8oyB.js";import{t as c}from"./jsx-runtime-D-D469L8.js";import{li as l,ui as u}from"./paths-DJg_jbfO.js";import{OS as d,_g as f,gg as p,jS as m}from"./loadAgentsDir-Bmfyrm8o.js";function h(){let e=f();return l()===`zh`?`# Skill Search (自动技能匹配)
...
`)}async function _(){if(f()&&process.env.SKILL_SEARCH_ENABLED!==`0`)return`Skill Search: already enabled`;process.env.SKILL_SEARCH_ENABLED=`1`;let e=[`Skill Search: enabled (SKILL_SEARCH_ENABLED=1)`];try{let{clearSkillIndexCache:t}=await import(`./localSearch-NeM_YaDK.js`);t(),e.push(`Skill index cache: cleared (will rebuild on next search)`)}catch{e.push(`Skill index cache: clear skipped`)}return e.join(`
