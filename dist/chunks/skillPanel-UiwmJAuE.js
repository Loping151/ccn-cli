import{n as e,o as t}from"./chunk-DR8-3Aex.js";import{Hr as n,Vr as r}from"./paths-Dat5Aobk.js";import{Rn as i,b as a,f as o,t as s,x as c,xt as l}from"./src-Kfqxxbsd.js";import{t as u}from"./jsx-runtime-BLYyAvvR.js";import{OS as d,jS as f}from"./loadAgentsDir-CAB37zdA.js";import{r as p,t as m}from"./featureCheck-Bwxz7WCq.js";function h(){let e=p();return r()===`zh`?`# Skill Learning (自动学习)
...
`}async function g(){let{readObservations:e,loadInstincts:t,resolveProjectContext:n}=await import(`./skillLearning-dPNKeTLr.js`),r=n(process.cwd()),[i,a]=await Promise.all([e({project:r}),t({project:r})]);return[`Skill Learning status for ${r.projectName} (${r.projectId})`,`Observations: ${i.length}`,`Instincts: ${a.length}`,``,`Skill Learning: ${p()?`enabled`:`disabled`}`].join(`
`)}async function _(){let e=[];p()?e.push(`Skill Learning: already enabled`):(process.env.SKILL_LEARNING_ENABLED=`1`,e.push(`Skill Learning: enabled (SKILL_LEARNING_ENABLED=1)`));try{let{initSkillLearning:t}=await import(`./runtimeObserver-FqVipGrw.js`);t(),e.push(`Runtime observer: initialized`)}catch{e.push(`Runtime observer: init skipped (not available)`)}return e.join(`
