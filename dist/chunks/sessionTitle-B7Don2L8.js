import{n as e}from"./chunk-DR8-3Aex.js";import{Ln as t,wn as n}from"./schemas-BF66sqUz.js";import{t as r}from"./v4-CsrzCakw.js";import{U as i,sn as a}from"./state-CH3cCJC5.js";import{l as o,p as s}from"./debug-DMnLghM9.js";import{t as c}from"./analytics-Oq2xIXA0.js";import{s as l,u}from"./types-BQBbxtRG.js";import{n as d,t as f}from"./lazySchema-BR0VtJ4S.js";import{Ak as p,Wo as m,is as h,nt as g,tt as _}from"./loadAgentsDir-S9pw76qt.js";import{X as v}from"./rcDebugLog-dTYGVIcm.js";function y(e){let t=[];for(let n of e){if(n.type!==`user`&&n.type!==`assistant`||`isMeta`in n&&n.isMeta||`origin`in n&&n.origin&&n.origin.kind!==`human`)continue;let e=n.message.content;if(typeof e==`string`)t.push(e);else if(Array.isArray(e))for(let n of e)`type`in n&&n.type===`text`&&`text`in n&&t.push(n.text)}let n=t.join(`
